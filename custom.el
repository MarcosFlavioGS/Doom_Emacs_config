...
(custom-set-variables
 ...
 '(package-selected-packages
   '(alchemist all-the-icons-nerd-fonts atom-one-dark-theme auto-virtualenv cargo
     cargo-mode cmake-mode company-go dap-mode darcula-theme dash dash-docs
     dracula-theme elixir-mode elixir-ts-mode ellama elpy
     evil-textobj-tree-sitter flycheck-credo flycheck-dialyzer flycheck-elixir
     flycheck-ocaml flycheck-rust flymd inkpot-theme linum-relative lsp-java
     lsp-mode lsp-pyright lsp-ui magit markdown-mode merlin merlin-ac
     merlin-company merlin-eldoc merlin-iedit mix nerd-icons obsidian
     ocamlformat pdf-tools picpocket prettier prettier-js prettier-rc projectile
     python-mode rust-mode rustic sbt-mode scala-ts-mode toml-mode utop web-mode
     yaml-mode zeno-theme zig-mode)))
(custom-set-faces
